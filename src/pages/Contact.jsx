    ...
    <div className="max-w-lg mx-auto pt-2">
      ...
      <div className="flex flex-col gap-2.5">
        {coordinators.map((c) => (
          <div
            key={c.id}
            className="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-surface-light dark:bg-surface-dark p-4 flex items-center justify-between"
          >
            ...
            <div className="flex gap-2">
              {c.phone && (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-base-light dark:bg-base-dark border border-black/10 dark:border-white/10 flex items-center justify-center text-accent"
                >
                  <Phone size={15} />
                </a>
              )}
